...
The main article area renders Markdown to HTML in the browser using [marked](https://marked.js.org/) and sanitizes output with [DOMPurify](https://github.com/cure53/DOMPurify).
